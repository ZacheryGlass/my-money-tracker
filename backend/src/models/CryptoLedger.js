...
const matchJson = (em, er, ea, mv) => `jsonb_build_object(
      ...
      'comparison_kind', ${em}.comparison_kind,
      'comparison_left_amount', ${em}.comparison_left_amount::text,
      'comparison_right_amount', ${em}.comparison_right_amount::text,
      'fee_amount_applied', ${em}.fee_amount_applied::text,
      'amount_delta', ${em}.amount_delta::text,
      'amount_tolerance', ${em}.amount_tolerance::text,
      'magnitude_ratio', ${em}.magnitude_ratio::text,
      'address_match', ${em}.address_match,
      'time_delta_seconds', ${em}.time_delta_seconds,
      'verdict', ${mv}.verdict,
...
const EXCHANGE_CTE = `
  exch AS (
    SELECT
      ...
      NULL::jsonb AS protocol_interpretation,
      '[]'::jsonb AS legs,
...
function toLedgerRow(row) {
  ...
  return {
    ...
    protocol_interpretation: row.protocol_interpretation,
    fee_wei: row.fee_wei,
