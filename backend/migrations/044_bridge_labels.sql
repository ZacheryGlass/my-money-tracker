...
--   base      https://docs.base.org/specifications/reference/base-contracts
...
INSERT INTO eth_address_labels (user_id, address, name, source, kind, confidence, note) VALUES
  ...
  (NULL, '0x9a873656c19efecbfb4f9fab5b7acdeab466a0b0', 'Gnosis: BridgeRouter (Ethereum)', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 1. Source: https://docs.gnosischain.com/bridges/About%20Token%20Bridges/xdai-bridge'),
  ...
  (NULL, '0x481c034c6d9441db23ea48de68bcae812c5d39ba', 'Gnosis: Block Reward Bridge Credit', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 100. Source: https://docs.gnosischain.com/bridges/About%20Token%20Bridges/xdai-bridge'),
  (NULL, '0x5c183c8a49aba6e31049997a56d75600e27ff8c9', 'Gnosis: USDS Deposit Contract', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 100. Source: https://docs.gnosischain.com/bridges/About%20Token%20Bridges/xdai-bridge'),
  ...
  (NULL, '0x3154cf16ccdb4c6d922629664174b904d80f2c35', 'Base: L1 Standard Bridge', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 1. Source: https://docs.base.org/specifications/reference/base-contracts'),
  (NULL, '0x49048044d57e1c92a77f79988d21fa8faf74e97e', 'Base: Portal', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 1. Source: https://docs.base.org/specifications/reference/base-contracts'),
  (NULL, '0x866e82a600a1414e583f7f13623f1ac5d58b0afa', 'Base: L1 Cross Domain Messenger', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 1. Source: https://docs.base.org/specifications/reference/base-contracts'),
  (NULL, '0x4200000000000000000000000000000000000010', 'OP Stack: L2 Standard Bridge', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 8453. Source: https://docs.base.org/specifications/reference/base-contracts'),
  (NULL, '0x4200000000000000000000000000000000000016', 'OP Stack: L2 To L1 Message Passer', 'builtin-bridge', 'bridge', 'high', 'Cross-chain bridge on chain 8453. Source: https://docs.base.org/specifications/reference/base-contracts'),
