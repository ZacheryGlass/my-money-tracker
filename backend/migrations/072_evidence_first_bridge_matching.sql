...
VALUES
  ...
  ('base', 'bedrock', 1, '0x3154cf16ccdb4c6d922629664174b904d80f2c35', 'Base: L1 Standard Bridge', 'standard_bridge', 'both', 'https://docs.base.org/specifications/reference/base-contracts', '{"docs_name":"L1StandardBridge","researched_on":"2026-07-29"}'::jsonb),
  ('base', 'bedrock', 1, '0x49048044d57e1c92a77f79988d21fa8faf74e97e', 'Base: Portal', 'portal', 'both', 'https://docs.base.org/specifications/reference/base-contracts', '{"docs_name":"OptimismPortal","researched_on":"2026-07-29"}'::jsonb),
  ('base', 'bedrock', 1, '0x866e82a600a1414e583f7f13623f1ac5d58b0afa', 'Base: L1 Cross Domain Messenger', 'cross_domain_messenger', 'both', 'https://docs.base.org/specifications/reference/base-contracts', '{"docs_name":"L1CrossDomainMessenger","researched_on":"2026-07-29"}'::jsonb),
  ('base', 'bedrock', 8453, '0x4200000000000000000000000000000000000010', 'OP Stack: L2 Standard Bridge', 'standard_bridge', 'both', 'https://docs.base.org/specifications/reference/base-contracts', '{"docs_name":"L2StandardBridge (predeploy, identical on OP Mainnet and Base)","researched_on":"2026-07-29"}'::jsonb),
  ('base', 'bedrock', 8453, '0x4200000000000000000000000000000000000016', 'OP Stack: L2 To L1 Message Passer', 'message_passer', 'both', 'https://docs.base.org/specifications/reference/base-contracts', '{"docs_name":"L2ToL1MessagePasser (predeploy, identical on OP Mainnet and Base)","researched_on":"2026-07-29"}'::jsonb),
