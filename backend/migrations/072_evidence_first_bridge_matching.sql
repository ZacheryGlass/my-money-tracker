...
-- 44 chain-scoped endpoints derived from the reviewed first-party pack.
...
VALUES
  ...
  ('optimism', 'bedrock', 10, '0x4200000000000000000000000000000000000010', 'Optimism: L2 Standard Bridge', 'standard_bridge', 'both', 'https://raw.githubusercontent.com/ethereum-optimism/superchain-registry/main/superchain/extra/addresses/addresses.json', '{"docs_name":"L2StandardBridge","researched_on":"2026-07-29"}'::jsonb),
  ('optimism', 'bedrock', 10, '0x4200000000000000000000000000000000000016', 'Optimism: L2 To L1 Message Passer', 'message_passer', 'both', 'https://raw.githubusercontent.com/ethereum-optimism/superchain-registry/main/superchain/extra/addresses/addresses.json', '{"docs_name":"L2ToL1MessagePasser","researched_on":"2026-07-29"}'::jsonb),
