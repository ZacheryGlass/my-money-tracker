...
- **Testing**: 285 backend (node:test + supertest, fake pg Pool via require.cache) and 46 frontend (vitest) — broad on scoping/secrets/admin, thin on charts and analytics
