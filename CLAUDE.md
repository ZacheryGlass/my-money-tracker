...
- **Testing**: 344 backend (node:test + supertest, fake pg Pool via require.cache) and 58 frontend (vitest) — broad on scoping/secrets/admin/CSV import, thin on charts and analytics
